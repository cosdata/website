...
interface PurposeBuiltFeatureTableProps {
  databases: PurposeBuiltDatabase[];
  features: Array<{ key: string; label: string }>;
}

export function PurposeBuiltFeatureTable({ databases, features }: PurposeBuiltFeatureTableProps) {
    ...
    <div className={`overflow-hidden shadow-lg border border-gray-200 ${afacad.className}`}>
      ...
      <div className={`p-5 bg-gray-50 text-base text-gray-600 flex items-center gap-6 border-t border-gray-200 ${geologica.className}`}>
        <div className="flex items-center gap-2">
          ...
          <span className="font-[500] text-base">Feature comparison across purpose-built databases</span>
        </div>
