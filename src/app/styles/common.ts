...
export const commonStyles = {
  ...
  sectionTitle: `text-3xl sm:text-[44px] font-bold text-center mb-8 text-[#0055c8] ${geologica.className}`,
  sectionSubtitle: `sm:text-xl md:text-2xl text-center text-[#374151] mb-12 ${afacad.className}`,
  ...
  featureLink: `px-4 py-2 bg-transparent text-[#3d8bff] border-2 border-[#3d8bff] rounded-md font-semibold text-base sm:text-lg ${afacad.className}`,
