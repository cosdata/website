...
export default function DocsPage() {
    return (
        <div className=" md:w-[90%] lg:w-full overflow-x-scroll">
                ...
                <div id="outline-container-org13f2380" className="outline-2">
                    ...
                    <div id="outline-container-org317a4f7" className="outline-3">
                        ...
                        <div id="outline-container-orga90d6b5" className="outline-4">
                            <h4 id="orga90d6b5">
                                <span className="section-number-4">4.2.1.</span> Transaction
                                Creation
                            </h4>
                        ...
                        <div id="outline-container-org33c1554" className="outline-4">
                            <h4 id="org33c1554">
                                <span className="section-number-4">4.2.2.</span> Transaction
                                Operations
                            </h4>
                        ...
                        <div id="outline-container-org8bed3d5" className="outline-4">
                            <h4 id="org8bed3d5">
                                <span className="section-number-4">4.2.3.</span> Transaction
                                Completion
                            </h4>
