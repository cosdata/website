...
export default function BenchmarksPage() {
  ...
  return (
    <main className={`bg-transparent ${noto_sans_mono.className}`}>
      <div className={`${commonStyles.mainContainer} max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12`}>
        <h1 className="text-[42px] font-bold text-center text-[#0055c8] mb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto mb-12">
          ...
          <div className="bg-white p-6 shadow-md border border-gray-200">
            <h2 className="text-[32px] font-bold mb-6 text-[#0055c8]">Performance Factors</h2>
            <p className="text-gray-700 mb-4">
        ...
        <div className="max-w-7xl mx-auto mb-12">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {cosdataConfigData.map((config, index) => (
                    <tr key={index} className={index % 2 === 0 ? "bg-gray-50" : "bg-white"}>
                      <td className="py-4 px-6 whitespace-nowrap font-medium text-gray-900">
                        <code className="text-sm bg-gray-100 px-2 py-1 rounded">{config.config}</code>
                      </td>
                      <td className="py-4 px-6 whitespace-nowrap text-gray-700">{config.indexingTime}</td>
                      <td className="py-4 px-6 whitespace-nowrap text-gray-700">{config.recall}</td>
                      <td className="py-4 px-6 whitespace-nowrap text-gray-700 font-medium">
          ...
          <div className="mb-12">
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
              <li>Lower <code className="text-sm bg-gray-100 px-2 py-1 rounded">ef_construction</code> and <code className="text-sm bg-gray-100 px-2 py-1 rounded">ef_search</code> values result in faster indexing times and higher RPS</li>
              <li>Higher <code className="text-sm bg-gray-100 px-2 py-1 rounded">ef_construction</code> and <code className="text-sm bg-gray-100 px-2 py-1 rounded">ef_search</code> values provide better recall accuracy</li>
              <li>The configuration with <code className="text-sm bg-gray-100 px-2 py-1 rounded">ef_construction: 64, ef_search: 128</code> offers an excellent balance between speed and accuracy</li>
              <li>For maximum throughput, the configuration with <code className="text-sm bg-gray-100 px-2 py-1 rounded">ef_construction: 32, ef_search: 32</code> delivers nearly 3,000 RPS</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center bg-white shadow-md overflow-hidden border border-gray-200 max-w-7xl mx-auto">
          <div className="md:w-3/4 p-8">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://github.com/cosdata/cosdata" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-5 py-2.5 bg-black hover:bg-gray-800 text-white rounded-lg transition-colors duration-300">
              ...
              <Link href="/products/cosdata-hnsw" className="inline-flex items-center px-5 py-2.5 bg-[#f23665] hover:bg-[#d92d5c] text-white rounded-lg transition-colors duration-300">
          ...
          <div className="md:w-1/4 p-8 flex justify-center">
            <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center">
              <svg className="w-12 h-12 text-[#0055c8]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
