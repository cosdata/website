              ...
              <div>
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full px-6 py-3 bg-[#f23665] text-white rounded-md hover:bg-[#d92d5c] transition-colors"
                    >
                      Send Message
                    </button>
                  </div>
                ...
                <p className="text-sm text-gray-500 mt-4">
                  * This form is currently for demonstration purposes. Please use the email address for actual inquiries.
                </p>
              </div>
            </div>
          </div>
