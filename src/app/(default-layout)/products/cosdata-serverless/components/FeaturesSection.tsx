      ...
      <div className={`${commonStyles.mainContainer} max-w-7xl mx-auto px-4 sm:px-6 lg:px-8`}>
        ...
        <div className="flex flex-col md:flex-row items-center mb-24">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0">
            <div className="w-full h-[300px] bg-gradient-to-br from-purple-50 to-indigo-100 rounded-lg flex items-center justify-center p-6">
            ...
            {features.map((feature, index) => (
              <div key={index} className="flex">
                <div className="flex-shrink-0 mr-6">
                  <div className="h-14 w-14 text-[#f23665] bg-pink-50 rounded-full flex items-center justify-center">
                    {feature.icon}
                  </div>
                </div>
                <div>
