  ...
  return (
    <section className="py-10 sm:py-12 md:py-16 bg-white px-4 sm:px-6">
      <div className={`${commonStyles.mainContainer} max-w-7xl mx-auto`}>
        ...
        <div className="flex flex-col md:flex-row items-center mb-10 sm:mb-16">
          <div className="md:w-1/2 md:pr-4 lg:pr-8">
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5 ml-1 sm:ml-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
              </svg>
            </a>
          </div>
          <div className="md:w-1/2 mt-6 md:mt-0 flex justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 text-[#0055c8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-10 sm:mb-16">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-[#0055c8] group-hover:text-[#f23665] transition-colors">{feature.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 sm:gap-x-12 gap-y-6 sm:gap-y-8">
            {additionalFeatures.map((feature, index) => (
              <div key={index} className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 text-green-500 mr-3 sm:mr-4 mt-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
