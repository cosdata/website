          ...
          <div className="px-4 sm:px-6 py-8 sm:py-10 md:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
              <button
                ...
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-white text-green-800 rounded-lg shadow-md hover:bg-gray-100 transition-colors duration-300 font-bold text-base sm:text-lg w-full sm:w-auto"
              >
