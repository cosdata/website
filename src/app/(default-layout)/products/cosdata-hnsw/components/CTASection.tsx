          ...
          <div className="px-6 py-12 md:p-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <a 
                ...
                className="inline-flex items-center px-8 py-4 bg-white text-[#0055c8] rounded-lg shadow-md hover:bg-gray-100 transition-colors duration-300 font-bold text-lg"
              >
