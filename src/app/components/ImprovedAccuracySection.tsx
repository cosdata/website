    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-b from-[#ffffff] to-[#f5dede] p-6 flex flex-col justify-between text-[#7db1ff]">
                    <h3 className="text-2xl font-bold mb-8">Improved accuracy leads to better decision-making.</h3>
                ...
                <div className="bg-gradient-to-b from-[#ffffff] to-[#f5dede] p-6 flex flex-col justify-between text-[#7db1ff]">
                    <h3 className="text-2xl font-bold mb-8">Faster and smoother user experience at any scale.</h3>
                    <p className='text-[#7db1ff]'>
                ...
                <div className="bg-gradient-to-b from-[#ffffff] to-[#f5dede] p-6 flex flex-col justify-between text-[#7db1ff]">
                    <h3 className="text-2xl font-bold mb-8">Saves time and money while simplifying processes.</h3>
                    <p className='text-[#7db1ff]'>
