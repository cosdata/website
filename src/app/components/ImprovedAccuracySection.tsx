        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-b from-[#ffffff] to-[#f5dede] p-6 flex flex-col justify-between text-[#7db1ff] duration-300 hover:translate-y-[-20px]">
                    <h3 className="text-2xl font-bold mb-8 text-[#0055c8]">Get more accurate results for better decisions.</h3>
                ...
                <div className="bg-gradient-to-b from-[#ffffff] to-[#f5dede] p-6 flex flex-col justify-between text-[#7db1ff]  duration-300 hover:translate-y-[-20px]">
                    <h3 className="text-2xl font-bold mb-8 text-[#0055c8]  ">Enjoy quick, smooth performance, regardless of size.</h3>
                    <p className='text-[#7db1ff]'>
                ...
                <div className="bg-gradient-to-b from-[#ffffff] to-[#f5dede] p-6 flex flex-col justify-between text-[#7db1ff]  duration-300 hover:translate-y-[-20px]">
                    <h3 className="text-2xl font-bold mb-8 text-[#0055c8]">Simplify processes, save time, and reduce costs.</h3>
                    <p className='text-[#7db1ff]'>
