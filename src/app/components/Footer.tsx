...
function Footer() {
  ...
  return (
    <footer className={`relative ${afacad.className}`}>
      <div className="bg-gray-100 text-gray-800 pb-8 pt-8 border-t border-gray-200">
        <div className={commonStyles.mainContainer}>
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-8">
            <div className="flex flex-col sm:items-center order-last sm:order-first">
              <div>
                ...
                <div className="flex flex-col items-start mt-4">
                  <p className={`${commonStyles.paragraph} text-gray-700 mb-4`}>Subscribe to our newsletter.</p>
                  {status !== 'success' ? (
                    <form onSubmit={handleSubmit} className="flex flex-col justify-center lg:items-center gap-2 w-full">
                      <input
                        type="email"
                        placeholder="Enter your email"
                        className={`w-full px-2 py-[0.36rem] rounded-md outline-none border-2 focus:border-[#3083fe] border-gray-300 bg-white text-gray-800 mb-2 sm:mb-0 ${afacad.className}`}
                        required
                        value={email}
                      ...
                      <button
                        type="submit"
                        className="inline-block bg-[#f23665] text-white px-4 py-2 rounded-lg shadow-md hover:bg-[#d92d5c] transition duration-300 flex items-center justify-center text-base w-full"
                    ...
                    <p className={`${commonStyles.paragraph} text-green-600 font-semibold`}>Success! Thank you for subscribing.</p>
                  )}
                  {status === 'error' && (
                    <p className={`${commonStyles.paragraph} text-red-500 mt-2`}>{errorMessage}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className='flex flex-col md:items-center'>
              <div>
                <h3 className={`text-lg font-semibold mb-4 text-gray-900 ${geologica.className}`}>Products</h3>
                <ul className={`space-y-2 ${commonStyles.paragraph} text-gray-700`}>
            ...
            <div className='flex flex-col md:items-center'>
              <div>
                <h3 className={`text-lg font-semibold mb-4 text-gray-900 ${geologica.className}`}>Resources</h3>
                <ul className={`space-y-2 ${commonStyles.paragraph} text-gray-700`}>
            ...
            <div className='flex flex-col md:items-center'>
              <div>
                <h3 className={`text-lg font-semibold mb-4 text-gray-900 ${geologica.className}`}>Company</h3>
                <ul className={`space-y-2 ${commonStyles.paragraph} text-gray-700`}>
