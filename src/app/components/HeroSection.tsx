        ...
        <div className="flex w-full justify-center">
          <div className="flex-grow flex flex-col px-2 py-6 sm:px-6">
            ...
            <div className="flex gap-4 flex-wrap ">
              <button onClick={openModal} className="inline-block bg-[#f23665] text-white px-4  py-3 rounded-lg shadow-md hover:bg-[#d92d5c] transition duration-300 flex items-center min-w-[189px]">
