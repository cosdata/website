...
const HeroSection = () => {
  ...
  return (
    <main className={`bg-transparent lg:mb-10 pt-24 sm:pt-32 md:pt-40 lg:pt-48 pb-20 flex justify-center ${noto_sans_mono.className}`}>
      <div className="max-w-[1400px] w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-[#374151] mb-6 md:mb-8 leading-relaxed max-w-3xl">
            Our Next-gen Vector Database powers advanced RAG pipelines for the future of data intelligence.
          </p>
          <div className="flex gap-4 flex-wrap justify-center">
            <button onClick={openModal} className="inline-block bg-[#f23665] text-white px-4 py-3 rounded-lg shadow-md hover:bg-[#d92d5c] transition duration-300 flex items-center min-w-[189px] justify-center">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z" />
              </svg>
              Get Early Access
            </button>
            <a href="https://github.com/cosdata/cosdata" target="_blank" rel="noopener noreferrer" className="inline-block bg-black text-white px-4 py-3 rounded-lg hover:bg-gray-800 transition duration-300 flex items-center min-w-[189px] justify-center">
