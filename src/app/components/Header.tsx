      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <button onClick={handleLoginClick} className="bg-[#f47a96] text-[rgb(255,255,255)] font-open-sans text-[15px] font-light leading-[22.5px] px-4 py-2 rounded-sm  duration-300  border-[#f47a96] border-2 hover:bg-white hover:text-black">Login</button>
