            ...
            <div className="p-8">
              <div className="flex items-center mb-5">
                <div className="w-14 h-14 rounded-full bg-blue-100 flex items-center justify-center mr-4">
                  <svg className="w-7 h-7 text-[#0055C8]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-6">
                <h5 className={`text-base font-semibold text-gray-800 mb-3 ${geologica.className}`}>Key Innovations:</h5>
              ...
              <Link 
                ...
                className="inline-flex items-center px-5 py-2.5 border border-transparent text-lg font-medium rounded-md text-white bg-[#0055C8] hover:bg-blue-800 transition-colors duration-300"
              >
                Read the Paper
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="p-8">
              <div className="flex items-center mb-5">
                ...
                <div>
                  <span className="text-sm font-semibold uppercase tracking-wider text-purple-600">Research Paper</span>
              ...
              <Link 
                ...
                className="inline-flex items-center px-5 py-2.5 border border-transparent text-lg font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 transition-colors duration-300"
              >
                Read the Paper
                <svg className="ml-2 -mr-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
