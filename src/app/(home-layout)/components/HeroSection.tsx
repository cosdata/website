...
const HeroSection = () => {
  ...
  return (
    <main className={`bg-transparent lg:mb-10 pt-20 sm:pt-28 md:pt-36 lg:pt-44 pb-20 flex justify-center ${commonStyles.mainContainer} max-w-5xl`}>
      <div className="w-full">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex gap-4 flex-wrap justify-center">
            ...
            <a href="https://github.com/cosdata/cosdata" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-md text-gray-900 bg-white hover:bg-gray-100 transition-colors duration-300">
